package swampsumo.com.utils.u.ui;
...
public class SlidingTabLayout extends HorizontalScrollView {
     ...
     */
    public void setCustomTabView(int layoutResId, int textViewId, int textIconId) {
        mTabViewLayoutId = layoutResId;
        mTabViewTextViewId = textViewId;
        mTabIconId = textIconId;
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabView == null) {
                ...
                iconView = createDefaultTabView(getContext());
            }
