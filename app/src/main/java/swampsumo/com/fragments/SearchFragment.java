...
public class SearchFragment extends Fragment {
    ...
    private SeekBar searchDistance = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        searchDistance = (SeekBar)v.findViewById(R.id.searchDistance);
        distance = (TextView)v.findViewById(R.id.distance);

        searchDistance.setProgress(progressChanged);
        distance.setText(progressChanged + " km");
